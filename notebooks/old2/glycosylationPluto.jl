...
# ╔═╡ ef37c7d8-2367-44a4-8374-88ffefc5fc47
using PlutoUI

# ╔═╡ f39bf988-a8d9-4da1-8ce4-443cc47c4eff


# ╔═╡ 51150bb6-776e-41ae-a021-cff5ac716d8b
@bind Ω Slider(0.1:0.1:2.0, default=1.0)

# ╔═╡ 28930253-205d-41ee-b501-7de5cc0af827
@bind Ωperp Slider(10.0:10.0:1000.0, default=100.0)

# ╔═╡ 8a1fe34a-8a7c-4eec-8260-3d599aa8c779
@bind N Slider(1:1:200, default=100)

# ╔═╡ 9f09cfab-32d7-46eb-9c28-1e9692fdb31e
@bind k_Cd Slider(0.0:0.01:2.0, default=1.0)

# ╔═╡ b89d0632-baea-4782-a1ff-1c4ed6d6317e
@bind k_Ca Slider(0.0:0.01:2.0, default=1.0)

# ╔═╡ 2f4a28ab-4e90-4d3a-a140-b11d8928700d
@bind k_Sd Slider(0.0:0.01:2.0, default=1.0)

# ╔═╡ b12b0b39-8569-429b-8376-8ca191c7a988
@bind k_Sa Slider(0.0:0.01:2.0, default=1.0)

# ╔═╡ a920f4e3-0683-4f24-85ca-96c6145cf8bf
@bind k₁ Slider(0.0:0.01:2.0, default=1.0, label="a")

# ╔═╡ 7004414d-e3d3-4730-8413-d4fcd4a86a66
@bind k₂ Slider(0.0:0.01:2.0, default=1.0)

# ╔═╡ c6db00aa-bc84-4ddc-8371-94995575dbdc
@bind k₃ Slider(0.0:0.01:2.0, default=1.0)

# ╔═╡ 6d4ceeb8-f91e-4263-b7e0-a8d71bbbe43a
@bind k₄ Slider(0.0:0.01:2.0, default=0.01)

# ╔═╡ 45847ac2-849c-4ee7-8c3d-96b6dd446c1f
@bind 𝓒 Slider(10.0:10.0:1000.0, default=100.0)

# ╔═╡ 3519fbee-aefb-4e3a-89e1-f4a3c8f49893
@bind 𝓢 Slider(10.0:10.0:1000.0, default=100.0)

# ╔═╡ e44ef5c5-0335-4950-afc8-7104b0c8dd98
@bind 𝓔 Slider(10.0:10.0:1000.0, default=1.0)

# ╔═╡ bfa1f1eb-21b9-4f43-bba6-dbfc8f387478
@bind D_C Slider(0.00:0.01:2.0, default=1.0)

# ╔═╡ fe492576-be5c-4069-ab33-336d12224736
@bind D_S Slider(0.00:0.01:2.0, default=1.0)

# ╔═╡ 5ddfec49-11f6-4783-b5d5-78118492a82e
@bind Tᵣ⁰ Slider(0.01:0.01:2.0, default=1.0)

# ╔═╡ 4f2aa62d-9428-4ca4-9e32-3d853429993e
begin
...
# ╔═╡ 692e640b-6fb3-42cc-9dc4-3c8b86f7ec85
