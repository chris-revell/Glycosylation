...
# h₀ = 0.1
# Ωperp = 5000    # Dimensional lumen footprint area
# Ω     = h₀*Ωperp      # Dimensional lumen volume 
# N     = 100     # Maximum polymer length 
# k_Cd  = 1.0 # Complex desorption rate
# k_Ca  = 0.1 # Complex adsorption rate
...
# 𝒮     = 100000.0
# ℰ     = 0.0000001
# D_C   = 0.00000000001  # Monomer/polymer diffusivity
# D_S   = 0.00000000001  # Substrate diffusivity
# Tᵣstar= 1000000000000000.0  # Release time
# ϕ     = 0.5
...
# using FromFile
# @from "$(srcdir("DerivedParameters.jl"))" using DerivedParameters
# derivedParams2 = derivedParameters(Ω, Ωperp, N, k_Cd, k_Ca, k_Sd, k_Sa, k₁, k₂, k₃, k₄, 𝒞, 𝒮, ℰ, D_C, D_S, Tᵣstar; checks=true)
# # @unpack L₀, E₀, C_b, S_b, δ_C, δ_S, α_C, α_S, C₀, S₀, Tᵣ, T̃ᵣ, K₂, K₃, K₄, σ, ϵ, 𝒟, β, h_C, h_S = derivedParams