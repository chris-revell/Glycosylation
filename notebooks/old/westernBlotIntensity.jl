...
fig = Figure()
ax = Axis(fig[1,1])
lines!(ax, νs./maximum(νs), wt, label="wt")
lines!(ax, νs./maximum(νs), GMAP210_1, label="GMAP210_1")
lines!(ax, νs./maximum(νs), GMAP210_2, label="GMAP210_2")
lines!(ax, νs./maximum(νs), Golgin160_2, label="Golgin160_2")
ax.xlabel = "ν"
